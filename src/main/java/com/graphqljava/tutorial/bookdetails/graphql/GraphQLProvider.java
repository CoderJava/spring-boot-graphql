...
public class GraphQLProvider {
    ...
    private RuntimeWiring buildWiring() {
        return RuntimeWiring.newRuntimeWiring()
                ...
                .type(newTypeWiring("Query").dataFetcher("profileById", graphQLDataFetchers.getProfileById()))
                .type(newTypeWiring("Query").dataFetcher("profileByEmail", graphQLDataFetchers.getProfileByEmailDataFetcher()))
